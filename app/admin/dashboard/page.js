...
import { ArrowRight, LogOut, Users, SlidersHorizontal, FileText } from "lucide-react";
...
export default function AdminDashboard() {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            description: "Set up and manage expense approval workflows.",
            icon: <SlidersHorizontal className="w-8 h-8 text-green-400" />,
        },
        {
            href: "/admin/expenses",
            title: "View All Expenses",
            description: "Review and manage all submitted expenses.",
